        ...
        if (empty($email) || empty($senha)) {
            ...
            if ($result['success']) {
                ...
                if ($user['user_type'] !== 'broker') {
                    $error_message = 'Acesso negado. Esta área é restrita a corretores.';
                } else {
                    // Login bem-sucedido
...
<head>
    ...
    <title>Login de Corretor - <?php echo APP_NAME; ?></title>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="casas_disponiveis.php">Casas Disponíveis</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" 
                           data-bs-toggle="dropdown" aria-expanded="false">Acesso</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="Login.php">Login Usuário</a></li>
                            <li><a class="dropdown-item active" href="Login_Corretor.php">Login Corretor</a></li>
                            <li><a class="dropdown-item" href="Login_ADM.php">Login Admin</a></li>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <strong>Área Profissional:</strong> Este acesso é exclusivo para corretores imobiliários.
                </div>
                ...
                <form method="post" action="">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <label for="senha">Senha Profissional</label>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="Login_ADM.php" class="btn btn-outline-danger">
