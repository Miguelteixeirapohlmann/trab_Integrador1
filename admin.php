                    ...
                    <table class="table table-striped mb-0" id="imoveisTable">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>R$ 250.000,00</td>
                                <td>Disponível</td>
                                <td><a href="Casas/Casa1.html" class="btn btn-sm btn-primary">Ver detalhes</a></td>
                            </tr>
                            <tr>
                                ...
                                <td>R$ 180.000,00</td>
                                <td>Disponível</td>
                                <td><a href="Casas/Casa2.html" class="btn btn-sm btn-primary">Ver detalhes</a></td>
                            </tr>
                            <tr>
                                ...
                                <td>R$ 150.000,00</td>
                                <td>Disponível</td>
                                <td><a href="Casas/Casa3.html" class="btn btn-sm btn-primary">Ver detalhes</a></td>
                            </tr>
                            <tr>
                                ...
                                <td>R$ 220.000,00</td>
                                <td>Disponível</td>
                                <td><a href="Casas/Casa4.html" class="btn btn-sm btn-primary">Ver detalhes</a></td>
                            </tr>
                            <tr>
                                ...
                                <td>R$ 310.000,00</td>
                                <td>Disponível</td>
                                <td><a href="Casas/Casa5.html" class="btn btn-sm btn-primary">Ver detalhes</a></td>
                            </tr>
                            <tr>
                                ...
                                <td>R$ 275.000,00</td>
                                <td>Disponível</td>
                                <td><a href="Casas/Casa6.html" class="btn btn-sm btn-primary">Ver detalhes</a></td>
                            </tr>
                            <tr>
                                ...
                                <td>R$ 199.000,00</td>
                                <td>Disponível</td>
                                <td><a href="Casas/Casa7.html" class="btn btn-sm btn-primary">Ver detalhes</a></td>
                            </tr>
                            <tr>
                                ...
                                <td>R$ 1,00</td>
                                <td>Disponível</td>
                                <td><a href="Casas/Casa8.html" class="btn btn-sm btn-primary">Ver detalhes</a></td>
                            </tr>
                            <tr>
                                ...
                                <td>R$ 185.000,00</td>
                                <td>Disponível</td>
                                <td><a href="Casas/Casa9.html" class="btn btn-sm btn-primary">Ver detalhes</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
