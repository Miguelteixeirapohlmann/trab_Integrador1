...
HTML;
    ...
    // Para clientes (user) - sem menu dropdown, apenas o nome
    if ($current_user['user_type'] === 'user') {
        echo <<<HTML
                                <li>
                                    <a class="dropdown-item disabled" href="#" style="cursor: default;">
                                        <i class="fas fa-info-circle me-2"></i>Bem-vindo ao sistema!
                                    </a>
                                </li>
HTML;
    }
