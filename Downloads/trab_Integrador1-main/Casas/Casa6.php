...
<head>
    ...
    #carouselCasa6 .carousel-inner { height: 400px; overflow: hidden; }
    #carouselCasa6 .carousel-item img { width: 100%; height: 400px; object-fit: cover; object-position: center; }
...
<body>
    ...
    <div class="container py-4">
        <div class="row align-items-center">
            <div class="col-md-6 mb-4 mb-md-0">
                ...
                <div id="carouselCasa6" class="carousel slide" data-bs-interval="false" data-bs-touch="false" data-bs-keyboard="false">
                    <div class="carousel-indicators">
                        ...
                        <button type="button" data-bs-target="#carouselCasa6" data-bs-slide-to="2" aria-label="Slide 3"></button>
                        <button type="button" data-bs-target="#carouselCasa6" data-bs-slide-to="3" aria-label="Slide 4"></button>
                        <button type="button" data-bs-target="#carouselCasa6" data-bs-slide-to="4" aria-label="Slide 5"></button>
                    </div>
                    <div class="carousel-inner rounded shadow" style="height: 400px; overflow: hidden;">
                        <div class="carousel-item active">
                            <img src="../imgs/Casa6/Casa6.0.jpg" class="d-block w-100" alt="Casa Solar dos Pássaros - Foto 1" style="width: 100%; height: 400px; object-fit: cover; object-position: center;">
                        </div>
                        <div class="carousel-item">
                            <img src="../imgs/Casa6/Casa6.1.jpg" class="d-block w-100" alt="Casa Solar dos Pássaros - Foto 2" style="width: 100%; height: 400px; object-fit: cover; object-position: center;">
                        </div>
                        <div class="carousel-item">
                            <img src="../imgs/Casa6/Casa6.2.jpg" class="d-block w-100" alt="Casa Solar dos Pássaros - Foto 3" style="width: 100%; height: 400px; object-fit: cover; object-position: center;">
                        </div>
                        <div class="carousel-item">
                            <img src="../imgs/Casa6/Casa6.3.jpg" class="d-block w-100" alt="Casa Solar dos Pássaros - Foto 4" style="width: 100%; height: 400px; object-fit: cover; object-position: center;">
                        </div>
                        <div class="carousel-item">
                            <img src="../imgs/Casa6/Casa6.4.jpg" class="d-block w-100" alt="Casa Solar dos Pássaros - Foto 5" style="width: 100%; height: 400px; object-fit: cover; object-position: center;">
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="mb-3">Casa em Parobé</h1>
                <span class="badge bg-primary mb-2">Corretor: Pedro Costa</span>
                <h4 class="text-success mb-4">Compra R$ 195.000,00
                ...
                <ul class="list-group mb-4">
                    ...
                    <li class="list-group-item"><strong>Área:</strong> Garagem</li>
                    <li class="list-group-item"><strong>Pátio:</strong> Sim</li>
                    <li class="list-group-item"><strong>Endereço:</strong> RUA LAGOINHA, 88, EMANCIPAÇÃO, Parobé - RS</li>
                    <li class="list-group-item">
                        <strong>Localização:</strong>
                        Próxima a praças, escolas, farmácias e transporte público.
                    </li>
                </ul>
                <p>
                    Casa confortável e garagem. Bairro tranquilo e arborizado.
                </p>
                <?php if ($auth->isLoggedIn() && isset($current_user['user_type']) && $current_user['user_type'] === 'admin'): ?>
                    <span class="admin-actions-inline" style="white-space: nowrap; display: inline-flex; gap: 0; align-items: center;">
                        <a href="../editar_casa.php?id=6" class="btn btn-warning mx-0 btn-admin-action"><i class="fas fa-edit me-1"></i> Editar</a>
                        <form method="POST" action="../gerenciar_imoveis.php" onsubmit="return confirm('Tem certeza que deseja excluir este imóvel?');" style="display:inline-block; margin:0;">
                            ...
                            <input type="hidden" name="casa_id" value="6">
                ...
                <?php elseif ($auth->isLoggedIn() && isset($current_user['user_type']) && $current_user['user_type'] === 'broker'): ?>
                    <div class="d-flex gap-3">
                        <a href="../editar_casa.php?id=6" class="btn btn-warning">Editar</a>
                    </div>
                <?php else: ?>
                    <div class="d-flex gap-3">
