...
<head>
    ...
    <title>Perfil do Corretor - Maria Souza</title>
...
<body>
    ...
    <div class="container my-5">
        <h2>Perfil do Corretor: Maria Souza</h2>
        <div class="mb-3">
            <span class="badge bg-secondary">Desabilitado</span>
            <span class="ms-3">Email: maria@email.com</span>
        </div>
    ...
    <script src="js/corretor-2.js"></script>
